...
export const products: Product[] = [
  ...
  // 3 — Zurtaan
  {
    ...
    image: "/zurtaan perfume.png",
    gallery: ["/zurtaan perfume.png"],
  ...
  // 4 — Zarfah
  {
    ...
    image: "/zarfah perfume.png",
    gallery: ["/zarfah perfume.png"],
  ...
  // 6 — Zurtaan Taster (5ml discovery size)
  {
    ...
    price: 300,
    sizes: [{ ml: 5, price: 300 }],
    size: "5ml",
    gradient: "product-gradient-zurtaan",
    image: "/zurtaan taster.png",
    gallery: ["/zurtaan taster.png", "/zurtaan perfume.png"],
    isTaster: true,
    badge: "TASTER",
    notes: {
      top: ["Lemon", "Ginger", "Lavender", "Mint"],
  ...
  // 7 — Zarfah Taster (5ml discovery size)
  {
    ...
    size: "5ml",
    gradient: "product-gradient-zarfah",
    image: "/zarfah taster.png",
    gallery: ["/zarfah taster.png", "/zarfah perfume.png"],
    isTaster: true,
    badge: "TASTER",
    notes: {
      top: ["Purple Passion Fruit", "Grapefruit", "Pineapple", "Tangerine", "Strawberry"],
  ...
  // 8 — Taster Duo (Zurtaan + Zarfah, one 5ml each)
  {
    ...
    image: "/zurtaan + zarfah taster.png",
    gallery: ["/zurtaan + zarfah taster.png"],
    isTaster: true,
    badge: "BEST VALUE",
    notes: {
